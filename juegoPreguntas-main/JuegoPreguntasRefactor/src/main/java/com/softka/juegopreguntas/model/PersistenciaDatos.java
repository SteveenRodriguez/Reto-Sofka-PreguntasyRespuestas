...
public class PersistenciaDatos {
    ...
    public static void almacenarDatos() {
        ...
        try {
            salidaDatos = new FileOutputStream("src/model/historico.txt");
    ...
    public static void mostrarDatos() {
        ...
        try {
            entradaDatos = new FileInputStream("src/model/historico.txt");
    ...
    public static void mostrarHistoricoJuego() {
        HISTORICO_JUEGO.forEach((jugador) -> {
            logger.info("Jugador: " + jugador.nombreJugador() + " Puntos: " + jugador.puntosJugador());
        });
    }
}
